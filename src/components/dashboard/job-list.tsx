    ...
    <li className="grid gap-3 rounded-lg border bg-slate-500/10 p-3 text-xs md:grid-cols-[auto,_2fr,1fr] md:justify-between md:gap-6 md:p-6 md:text-base">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-1">
        <Dialog>
          ...
          <DialogContent>
            <div className="min-h-dm container grid content-center py-6 md:py-12">
              <div className="mx-auto w-[min(100%,_500px)] space-y-3 rounded-lg border bg-background p-3 md:space-y-6 md:p-6">
